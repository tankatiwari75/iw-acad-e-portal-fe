...
function UpdateResult(props) {
    ...
    const fetchData = async () => {
        const fetchedData = await fetch(`http://127.0.0.1:8000/teachers/update-result/${props.match.params.id}`);
    ...
    const handleSubmit = () => {
        const fetchnoticepost = fetch(`http://127.0.0.1:8000/teachers/update-result/${props.match.params.id}/`,
            {
                method: 'PUT',
            ...
            .then(res => res.json())
            .then(() => window.location ="/result-upload");
        // .then(redirection)
                ...
                <div className='row text-left'>
                    ...
                    <FormGroup className="col-sm-6">
                        ...
                        <Input
                            ...
                            name="id"
                            id="id"
                            defaultValue={datas.teacher_name}
                            disabled
                            required />
                    </FormGroup>
                    <FormGroup className="col-sm-6">
